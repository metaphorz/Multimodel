...
points remain visible beneath the translucent bands (Figure~\ref{fig:anim}, right);
...
the default): $t=0$---the eye at the coast with the eyewall over
Miami/Fort~Lauderdale, the translucent bands letting the grid points show through.
Speed / opacity sliders and Narrow/Wide buttons sit on the control bar; Reset
restores the static peak-wind footprint at the default zoom.}
\label{fig:anim}
\end{figure}
